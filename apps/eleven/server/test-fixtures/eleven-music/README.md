...
The repository's MIT license covers the source code and documentation. It does not cover the MP3 files in this fixture corpus.

The MP3 files exist only as test inputs. Audio generated by a deployed station is not part of this repository.
